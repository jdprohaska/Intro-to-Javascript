...
{
	let todaysDate = new Date();			//create a new date object with current date
	
	let dayOfWeek = todaysDate.getDay();	//get the value of the day from current date
...
{
	let todaysDate = new Date();	//create a date object with the current date
...
function getCurrentMonth()
{
	...
	return todaysDate.getMonth()+1;	//get current month add 1 to format it correctly	
}
...
{
	let todaysDate = new Date();		//create a date object with current date
...
function getDayOfWeekOfDate(inMonth,inDay,inYear)
{
	...
	let workingDate = new Date(inYear, inMonth-1, inDay);		//create a date object using the parameters
...
function getMonthOfDate(inMonth,inDay,inYear)
{
	...
	let workingDate = new Date(inYear, inMonth-1, inDay);			//create a date object with the current date
